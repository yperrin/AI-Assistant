...
summary: This document outlines how to leverage GitHub Copilot's advanced features,
  including Instructions, Skills, and Custom Agents, to enforce coding standards,
  automate development workflows, and perform specialized project-wide tasks like
  accessibility or SEO reviews. It provides specific use cases and solutions for integrating
  these features into a development pipeline.
